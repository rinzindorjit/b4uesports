...
export default function ProfileModal({ isOpen, onClose }: ProfileModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Sending profile update request to /api/users with POST method and updateProfile action');
      // Change from PUT to POST with action parameter as required by the API implementation
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" data-testid="profile-modal">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Edit your profile information including email, phone number, country, and game accounts.
            </DialogDescription>
          </DialogHeader>
