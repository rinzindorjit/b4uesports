...
async function sendPurchaseConfirmationEmail(params) {
  ...
  const testnetWarning = params.isTestnet ? `<div style="background: #FEF3C7; border: 1px solid #F59E0B; padding: 16px; border-radius: 8px; margin: 20px 0;">
         <p style="color: #92400E; margin: 0; font-weight: bold;">
           \u{1F6A7} TESTNET TRANSACTION - No real Pi coins were deducted from your mainnet wallet.
         </p>
       </div>` : "";
  const emailHTML = `
    <!DOCTYPE html>
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 14px;">
        <p>\xA9 2025 B4U Esports. All Rights Reserved.</p>
